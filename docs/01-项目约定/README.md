...
4. [05-SSH与令牌迁移说明.md](d:/tranding/tranding_agents_cn/cntrandingagents/docs/01-项目约定/05-SSH与令牌迁移说明.md)
...
8. [10-发布与镜像规则.md](d:/tranding/tranding_agents_cn/cntrandingagents/docs/01-项目约定/10-发布与镜像规则.md)
...
4. 再看“哪些文件允许改，哪些不允许改”。
5. 最后再看“发布怎么做、GitHub/Gitee 怎么同步”。
